...
<section class="error-section pt-0">
    <div class="container">
        <div class="banner-content text-center">
            <img class="img-fluid banner-img mx-auto" src="assets/images/404.webp" alt="404" />
            <p>
            ...
            <a href="index.php" class="btn theme-outline d-inline-flex mx-auto">Back To Home</a>
        </div>
    </div>
</section>
<!-- 404 section end -->
