        ...
        <table class="w-full whitespace-no-wrap">
            ...
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <div class="flex items-center text-sm">
                            ...
                            <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                <img class="object-cover w-full h-full rounded-full"
                                    src="../assets/images/product/item-1.webp" alt="" loading="lazy" />
                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                            </div>
                            <div>
                                <p class="font-semibold">ID: # <span id="order-id">88005d3a</span>
                                </p>
                    ...
                    <td class="px-4 py-3 text-sm"><span id="currency">$</span> <span>12</span></td>
...
<script>
    $(document).ready(function () {
        ...
        // Function to fetch totals from the server
        function fetchOrders() {
            $.ajax({
                url: '../api/api.php?action=get_orders_details',
                method: 'GET',
                dataType: 'json',
